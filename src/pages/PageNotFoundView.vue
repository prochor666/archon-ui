    ...
    <div>
        <main>
            <div class="w-full text-center select-none">
                <div
                    class="flex justify-center items-center text-gray-400 bg-gray-900 text-xl font-medium px-4 py-8"
                >
                    <BrandLogo css-class="h-7 w-auto mr-2" />
                    {{ t('brand') }}
                </div>
                <div
                    class="inline-block flex justify-center items-center text-gray-600 text-base font-medium"
                >
                    <p class="p-6">
                        <MdiWebCancel class="-mt-1 mr-2 h-5 w-5 inline" />
                        {{ t('Page404') }}
                    </p>
                </div>
                <div
...
import { MdiChevronLeft, MdiWebCancel } from 'materialdesignicons-vue3/icons/';
